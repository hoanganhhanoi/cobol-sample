...
001606 
001607 01 PRINT-INFO-ERROR.
001608 	02 FILLER			PIC X(22)	 VALUE "TOTAL RECORDS ERROR : ".
001609 	02 COUNT-RECORD-ERROR	PIC 9(8) VALUE 0.
001610 	
001611 01 PRINT-INFO-RECORD.
001612 	02 FILLER			PIC X(16)	VALUE "TOTAL RECORDS : ".
001613 	02 COUNTER 			PIC 9(8) 	VALUE 0.
001614 
001615 01 GROUP-PRODUCT.
001616 	02 GROUP-ID			PIC 9.
001617 	02 PREV-GROUP-ID	PIC 9		VALUE ZERO.
001618 	02 GROUP-TOTAL		PIC 9(9)	VALUE ZEROS.
001619 		
001620 01 EOF-FILE				PIC X 		VALUE "N".
001622 01 PRICE-TOTAL			PIC 9(8) 	VALUE ZERO.
001623 01 CHECK-PRICE			PIC 9 		VALUE 0.
001626 01 CHECK-QUANTITY		PIC 9 		VALUE 0.
...
001852 		
001853 		MOVE PRINT-INFO-ERROR TO LINE-RECORD
001854 		WRITE LINE-RECORD
001855 		MOVE PRINT-INFO-RECORD TO LINE-RECORD
001856 		WRITE LINE-RECORD
001857 		
001858 		DISPLAY REPORT-FOOTING
001859 		MOVE REPORT-FOOTING TO LINE-RECORD
001860 		WRITE LINE-RECORD
001861 		
001862 		CLOSE SORTED-PRODUCT-FILE
001863 		CLOSE FILE-OUT
001870 		ACCEPT DELAY
001880 		STOP RUN.
001881 		
001890 READ-FILE.
...
002622		END-READ.
002623		
002624 PRINT-GROUP-TOTAL.
002625 		MOVE GROUP-ID 			TO PR-GROUP-ID
002626		MOVE GROUP-TOTAL		TO PR-GROUP-TOTAL
002627		MOVE PRINT-GROUP-LINE 	TO LINE-RECORD 
002628		DISPLAY PRINT-GROUP-LINE
002629		WRITE LINE-RECORD.
002630
002631 PRINT-SHOP-TOTAL.
002632 		MOVE PRICE-TOTAL TO PRINT-TOTAL
002633 		MOVE PRINT-SHOP-PRICE-TOTAL TO LINE-RECORD
002634 		DISPLAY PRINT-SHOP-PRICE-TOTAL
002635 		WRITE LINE-RECORD.
002636		
002637 END PROGRAM DEMO.
002640