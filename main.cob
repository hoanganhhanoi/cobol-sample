...
001594 	02 FILLER					PIC X(8) VALUE SPACES.
...
002621 		WRITE LINE-RECORD FROM PRINT-PRODUCT-VALUE
002622 		READ SORTED-FILE-PRODUCT
002623		 	AT END
002624		 		MOVE "Y" TO EOF-FILE
002625		 	NOT AT END
002626		 		COMPUTE COUNTER = COUNTER + 1
002627		END-READ.
002628
002629* WRITE RECORD ERROR TO FILE AND DISPLAY TO CONSOLE		
002630 PRINT-ERROR.
002631 		DISPLAY PR-ERROR
002632 		WRITE LINE-RECORD FROM PR-ERROR
002633 		READ SORTED-FILE-PRODUCT
002634		 	AT END
002635		 		MOVE "Y" TO EOF-FILE
002636		 	NOT AT END
002637		 		COMPUTE COUNTER = COUNTER + 1
002638		END-READ.
002639
002640* WRITE GROUP TOTAL TO FILE AND DISPLAY TO CONSOLE 		
002641 PRINT-GROUP-TOTAL.
002642 		MOVE GROUP-ID 			TO PR-GROUP-ID
002643		MOVE GROUP-TOTAL		TO PR-GROUP-TOTAL
002644		DISPLAY PRINT-GROUP-LINE
002645		WRITE LINE-RECORD FROM PRINT-GROUP-LINE.
002646
002647* WRITE TOTAL PRICE TO FILE AND DISPLAY TO CONSOLE
002648 PRINT-TOTAL-PRICE.
002649 		MOVE PRICE-TOTAL TO PRINT-TOTAL
002650 		DISPLAY PRINT-PRICE-TOTAL
002651 		WRITE LINE-RECORD FROM PRINT-PRICE-TOTAL.
002652		
002653 END PROGRAM DEMO.
002660