...
001620 	
001621 01 PRINT-INFO-RECORD.
001622  02 FILLER				PIC X(9)	VALUE SPACES.
001623 	02 FILLER				PIC X(16)	VALUE "TOTAL RECORDS : ".
001624 	02 PR-COUNTER 			PIC zz,zz9 BLANK WHEN ZEROS.
001625 
001626 01 GROUP-PRODUCT.
001627 	02 GROUP-ID			PIC 9.
001628 	02 PREV-GROUP-ID	PIC 9		VALUE ZERO.
001629 	02 GROUP-TOTAL		PIC 9(9)	VALUE ZEROS.
001630 		
001631 01 EOF-FILE				PIC X 		VALUE "N".
001632 01 CHECK-PRICE			PIC 9 		VALUE ZERO.
...
002616 		ACCEPT DELAY.
002617
002618* WRITE PRODUCT DETAIL TO FILE AND DISPLAY TO CONSOLE 			
002619 PRINT-PRODUCT.
002620 		DISPLAY PRINT-PRODUCT-VALUE
002621 		IF PAGE-LINES-WRITTEN > 20
002622 			WRITE LINE-RECORD FROM PRINT-PRODUCT-VALUE 
002623 				AFTER ADVANCING PAGE
002624 			MOVE 0 TO PAGE-LINES-WRITTEN
002625 			ADD 1 TO PAGE-NUMBER
002626 		ELSE
002627 			WRITE LINE-RECORD FROM PRINT-PRODUCT-VALUE
002628 		END-IF
002629 		
002630 		READ SORTED-FILE-PRODUCT
002631		 	AT END
002632		 		MOVE "Y" TO EOF-FILE
002633		 	NOT AT END
002634		 		ADD 1 TO COUNTER
002635		 		ADD 1 TO PAGE-LINES-WRITTEN
002636		END-READ.
002637
002638* WRITE RECORD ERROR TO FILE AND DISPLAY TO CONSOLE		
002639 PRINT-ERROR.
002640 		DISPLAY PR-ERROR
002641 		IF PAGE-LINES-WRITTEN > 20
002642 			WRITE LINE-RECORD FROM PR-ERROR
002643 				AFTER ADVANCING PAGE
002644 			MOVE 0 TO PAGE-LINES-WRITTEN
002645 			ADD 1 TO PAGE-NUMBER
002646 		ELSE
002647 			WRITE LINE-RECORD FROM PR-ERROR
002648 		END-IF
002649 		
002650 		READ SORTED-FILE-PRODUCT
002651		 	AT END
002652		 		MOVE "Y" TO EOF-FILE
002653		 	NOT AT END
002654		 		ADD 1 TO COUNTER
002655		 		ADD 1 TO PAGE-LINES-WRITTEN
002656		END-READ.
002657
002658* WRITE GROUP TOTAL TO FILE AND DISPLAY TO CONSOLE 		
002659 PRINT-GROUP-TOTAL.
002660 		MOVE GROUP-ID 			TO PR-GROUP-ID
002661		MOVE GROUP-TOTAL		TO PR-GROUP-TOTAL
002662		DISPLAY PRINT-GROUP-LINE
002663		WRITE LINE-RECORD FROM PRINT-GROUP-LINE.
002664
002665* WRITE TOTAL PRICE TO FILE AND DISPLAY TO CONSOLE
002666 PRINT-TOTAL-PRICE.
002667 		MOVE PRICE-TOTAL TO PRINT-TOTAL
002668 		DISPLAY PRINT-PRICE-TOTAL
002669 		WRITE LINE-RECORD FROM PRINT-PRICE-TOTAL.
002670		
002671 END PROGRAM DEMO.
002680