...
001802   	USING PRODUCT GIVING SORTED-FILE-PRODUCT
001803* OPEN FILE OUTPUT   	
001804   	OPEN OUTPUT FILE-OUT
001805   	
001810 		DISPLAY REPORT-HEADING
001811 		DISPLAY REPORT-COLUMN
001812 		
001814 		WRITE LINE-RECORD FROM REPORT-HEADING
001816 		WRITE LINE-RECORD FROM REPORT-COLUMN
001817 		
...
001852 		
001856 		WRITE LINE-RECORD FROM PRINT-INFO-ERROR
001861 		WRITE LINE-RECORD FROM PRINT-INFO-RECORD
001862 		
001863 		DISPLAY REPORT-FOOTING
001865 		WRITE LINE-RECORD FROM REPORT-FOOTING
001866 		
001867 		CLOSE SORTED-FILE-PRODUCT
...
001882* READ FILE 		
001890 READ-FILE.
001900 		OPEN INPUT SORTED-FILE-PRODUCT
...
002510 	
002612 PRINT-PRODUCT.
002615 		DISPLAY PRINT-PRODUCT-VALUE
002616 		WRITE LINE-RECORD FROM PRINT-PRODUCT-VALUE
002617 		READ SORTED-FILE-PRODUCT
002618		 	AT END
...
002623		
002624 PRINT-ERROR.
002626 		DISPLAY PR-ERROR
002627 		WRITE LINE-RECORD FROM PR-ERROR
002628 		READ SORTED-FILE-PRODUCT
002629		 	AT END
002630		 		MOVE "Y" TO EOF-FILE
002631		 	NOT AT END
002632		 		COMPUTE COUNTER = COUNTER + 1
002633		END-READ.
002634		
002635 PRINT-GROUP-TOTAL.
002636 		MOVE GROUP-ID 			TO PR-GROUP-ID
002637		MOVE GROUP-TOTAL		TO PR-GROUP-TOTAL
002639		DISPLAY PRINT-GROUP-LINE
002640		WRITE LINE-RECORD FROM PRINT-GROUP-LINE.
002641
002642 PRINT-SHOP-TOTAL.
002643 		MOVE PRICE-TOTAL TO PRINT-TOTAL
002645 		DISPLAY PRINT-PRICE-TOTAL
002646 		WRITE LINE-RECORD FROM PRINT-PRICE-TOTAL.
002647		
002648 END PROGRAM DEMO.
002650